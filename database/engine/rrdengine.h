...
struct rrdengine_statistics {
    ...
    rrdeng_stats_t pg_index_lookup_hit_last;
    ...
    rrdeng_stats_t pg_index_lookup_hit_first;
    rrdeng_stats_t pg_preload_descr_populated;
    rrdeng_stats_t pg_preload_descr_queued;
    rrdeng_stats_t pg_preload_descr_fail_cache_check;
