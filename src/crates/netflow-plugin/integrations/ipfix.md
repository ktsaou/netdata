...
IPFIX can be monitored further using the following other integrations:

- [NetFlow](/src/crates/netflow-plugin/integrations/netflow.md)
- [sFlow](/src/crates/netflow-plugin/integrations/sflow.md)
