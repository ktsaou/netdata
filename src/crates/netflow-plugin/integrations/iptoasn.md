...
[IPtoASN](https://iptoasn.com/) is a free, public-domain feed of IP-to-ASN
mappings derived from BGP RIB snapshots. The upstream publishes its dataset
...
and rebuilds it hourly, making it the highest-cadence and lowest-friction
public ASN source available. Use it as a free, open alternative to MaxMind
ASN data when license cost or terms matter.
