...
This guide covers everything you need to build both simple monitoring functions and advanced log explorers. For implementation details and edge cases, see [FUNCTIONS_REFERENCE.md](/docs/developer-and-contributor-corner/external-plugins/functions-v3-protocol-reference).
