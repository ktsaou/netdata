...
| **6.2 Service and Availability Alerts** | Service health, stale collectors, HTTP checks |
| **6.3 Application-Level Alerts** | Databases, web servers, caches, message queues |
...
- Start with **6.1** if you need system resource alerts
- Jump to **6.2** for service and availability monitoring
- Use **6.3** for application-specific examples
- Go to **6.4** for ML-based anomaly detection

## What's Next

- **6.1 Core System Alerts** covers CPU, memory, disk, network
- **6.2 Service and Availability Alerts** for health checks
